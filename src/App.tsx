...
<div className="mt-4 py-2 flex flex-col items-center space-y-2 z-30 w-full">
          <a 
            ...
            className="bg-[#E84A8F] text-white font-bold py-2 px-4 rounded-2xl transition-all duration-300 active:scale-95 flex items-center space-x-2 text-sm hover:bg-[#F05FA4] hover:shadow-[0_4px_12px_rgba(232,74,143,0.2)]"
          >
          ...
          <div className="text-xs text-gray-600">© {new Date().getFullYear()} ajitesh gogoi</div>
        </div>
      </div>
    </>
  );
